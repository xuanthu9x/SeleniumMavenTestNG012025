...
public class AddCustomerLocator {
    ...
    public static String groupDropdown = "//label[normalize-space()='Groups']/following::select[@id='groups_in[]']";
    ...
    public static String optionSearchCountry = "//div[@id='bs-select-4']/descendant::span[contains(text(),'Afghanistan')]";
